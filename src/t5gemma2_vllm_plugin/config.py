...
if HAS_NATIVE_T5GEMMA2_CONFIG:
    ...
    class T5Gemma2Config(HFT5Gemma2Config):
        ...
        def __init__(self, *args: Any, **kwargs: Any) -> None:
            ...
            # HF T5Gemma2 leaves decoder_start_token_id unset and generate()
            # falls back to bos_token_id. Match that so vLLM starts decoding
            # with the same token as the reference implementation.
            if getattr(self, "decoder_start_token_id", None) is None:
